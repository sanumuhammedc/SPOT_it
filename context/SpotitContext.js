...
import { spotitAbi, spotitCoinAddress } from '../lib/constants'
import { ethers } from 'ethers'

export const SpotitContext = createContext()

export const SpotitProvider = ({ children }) => {
  ...
  const buyTokens = async () => {
    ...
    console.log(spotitCoinAddress)

    let options = {
      contractAddress: spotitCoinAddress,
      functionName: 'mint',
      abi: spotitAbi,
      msgValue: calcPrice,
      params: {
